...
def padronizaRenovacao(caminho_original, caminho_editado, ano_mes):
    ...
    header = ['Cia', 'Ramo', 'Apolice','Item',
        'Segurado','Vigencia',
        'CI', 'Qtd Sinistros por Apólice']  # Replace with your desired header names
    df.columns = header
    # Define your desired header
    header2 = ['Companhia' , 'Assessoria', 'Sucursal', 'Inspetor de produção','Corretor', 'Ramo Seguro','Frota itens']  # Replace with your desired header names (novo)
    ...
    df.loc[df['Cia'] == 'Não existem apólices a renovar.', 'Cia'] = pd.NA
